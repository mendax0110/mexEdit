...
namespace mexedit::features
{
    ...
    public:
         ...
         */
        [[nodiscard]] const std::filesystem::path& getCurrentDirectory() const { return currentPath_; }
         ...
         */
        [[nodiscard]] const std::vector<FileEntry>& getEntries() const { return entries_; }
         ...
         * @return size_t
         */
        [[nodiscard]] size_t getSelectedIndex() const { return selectedIndex_; }
         ...
         * @return false
         */
        [[nodiscard]] bool hasSelection() const { return selectedIndex_ < entries_.size(); }
         ...
         */
        [[nodiscard]] bool getShowHiddenFiles() const { return showHiddenFiles_; }
